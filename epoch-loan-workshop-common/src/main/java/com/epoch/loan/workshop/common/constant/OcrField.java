...
public class OcrField {
    ...
    /** advance认证失败 */
    public static final String ADVANCE_OCR_NO_RESULT_MESSAGE = "La comprobación del OCR ha fallado, no se ha podido encontrar ningún campo disponible en la imagen cargada";
